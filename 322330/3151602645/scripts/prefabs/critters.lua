...
return MakeCritter("critter_lamb", "sheepington", 6, standard_diet, false, {favoritefood="guacamole", allow_platform_hopping=true}),
       ...
       --==钢铁组件升级版==--
       MakeCritter("critter_puppy_iron", "pupington_iron", 4, standard_diet, false, {favoritefood="monsterlasagna", allow_platform_hopping=true}),
       MakeBuilder("critter_puppy_iron"),
       MakeCritter("critter_lamb_iron", "sheepington_iron", 6, standard_diet, false, {favoritefood="guacamole", allow_platform_hopping=true}),
       MakeBuilder("critter_lamb_iron"),
       MakeCritter("critter_kitten_iron", "kittington_iron", 6, standard_diet, false, {favoritefood="fishsticks", playmatetags={"kitcoon"}, allow_platform_hopping=true}),
       MakeBuilder("critter_kitten_iron"),
       MakeCritter("critter_perdling_iron", "perdling_iron", 4, standard_diet, false, {favoritefood="trailmix", allow_platform_hopping=true}),
       MakeBuilder("critter_perdling_iron"),
       MakeCritter("critter_dragonling_iron", "dragonling_iron", 6, standard_diet, true, {favoritefood="hotchili", flyingsoundloop="dontstarve_DLC001/creatures/together/dragonling/fly_LP"}),
       MakeBuilder("critter_dragonling_iron"),
       MakeCritter("critter_glomling_iron", "glomling_iron", 6, standard_diet, true, {favoritefood="taffy", playmatetags={"glommer"}, flyingsoundloop="dontstarve_DLC001/creatures/together/glomling/flap_LP"}),
       MakeBuilder("critter_glomling_iron"),
       MakeCritter("critter_lunarmothling_iron", "lunarmoth_iron", 4, standard_diet, true, {favoritefood="flowersalad", flyingsoundloop="dontstarve_DLC001/creatures/together/dragonling/flap_LP", special_powers_fn = lunarmoth_special_powers_fn}, {"critterbuff_lunarmoth"}),
       MakeBuilder("critter_lunarmothling_iron"),
       MakeCritter("critter_eyeofterror_iron", "eyeofterror_mini_iron", 6, standard_diet, true, {buildname = "eyeofterror_mini_iron_basic", favoritefood="baconeggs"--[[, flyingsoundloop = "a hover loop here, IF we want it"]] }),
       MakeBuilder("critter_eyeofterror_iron")