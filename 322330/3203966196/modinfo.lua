...
description = [[
    v 1.6
    可以用弹性空间制造器升级背包，保鲜背包，猪皮包，厨师袋，种子袋，糖果袋，冰箱，盐盒，极地熊獾桶,
    坎普斯背包，嚎弹炮,鱼人军械库,高级鱼人军械库,劣质工具棚，不那么劣质的工具棚。
    均可在mod配置中设置是否可以升级
     ]] -- mod描述
author = "安深余" -- mod作者
version = "1.6" -- mod版本,更新mod需要两次的版本不一样
forumthread = "" -- 官方论坛相关
...
configuration_options = {
    ...
    name = "是否升级嚎弹炮", -- 配置项名换，在modmain.lua里获取配置值时要用到
    hover = "", -- 鼠标移到配置项上时所显示的信息
    options = { { -- 配置项目可选项
        description = "是", -- 可选项上显示的内容
        hover = "是", -- 鼠标移动到可选项上显示的信息
        data = 1 -- 可选项选中时的值，在modmain.lua里获取到的值就是这个数据，类型可以为整形，布尔，浮点，字符串
    ...
    name = "是否升级鱼人军械库", -- 配置项名换，在modmain.lua里获取配置值时要用到
    hover = "", -- 鼠标移到配置项上时所显示的信息
    options = { { -- 配置项目可选项
        description = "是", -- 可选项上显示的内容
        hover = "是", -- 鼠标移动到可选项上显示的信息
    ...
    name = "是否升级高级鱼人军械库", -- 配置项名换，在modmain.lua里获取配置值时要用到
    hover = "", -- 鼠标移到配置项上时所显示的信息
    options = { { -- 配置项目可选项
        description = "是", -- 可选项上显示的内容
        hover = "是", -- 鼠标移动到可选项上显示的信息
    ...
    name = "是否升级劣质工具棚", -- 配置项名换，在modmain.lua里获取配置值时要用到
    hover = "", -- 鼠标移到配置项上时所显示的信息
    options = { { -- 配置项目可选项
        description = "是", -- 可选项上显示的内容
        hover = "是", -- 鼠标移动到可选项上显示的信息
    ...
    name = "是否升级不那么劣质的工具棚", -- 配置项名换，在modmain.lua里获取配置值时要用到
    hover = "", -- 鼠标移到配置项上时所显示的信息
    options = { { -- 配置项目可选项
        description = "是", -- 可选项上显示的内容
        hover = "是", -- 鼠标移动到可选项上显示的信息
