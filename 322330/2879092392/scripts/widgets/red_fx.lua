...
local Red_fx = Class(Widget, function(self, owner)
    self.owner = owner
    Widget._ctor(self, "Red_fx")
    self:SetClickable(false)
    self.bg = self:AddChild(Image("images/fx/gemvision_red.xml", "gemvision_red.tex"))
