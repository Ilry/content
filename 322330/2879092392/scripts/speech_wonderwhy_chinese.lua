...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        WHY_CHURCHSTATUE_OPAL = "爱让我们最终走到一起.",
          ...
          --1.8.9
        ANCIENTDREAMS_HYUBSIP = "别担心，这一次这些碎片并不是真的“在”食物里.",
        ANCIENTDREAMS_KOZISIP = "仙人掌和西瓜，完美的混合",
        ANCIENTDREAMS_TART = "副作用可能包括发光。",
        WHYSPEAR = "它会完成工作的.",
        ANCIENTDREAMS_EVILBRED = "我希望你喜欢这个，我倾尽全力了。",
        ANCIENTDREAMS_GELL = "浮夸的皇室很喜欢这款，因为它有一种轻盈的感觉。",
        ANCIENTDREAMS_QUASO = "大丰收后的一餐。",
        ANCIENTDREAMS_FHISH = "我们过去就是这样做最紧实的肉的。",
        ANCIENTDREAMS_LOMBTER = "我们把龙虾压在面包里。",
        ANCIENTDREAMS_PIZZA = "结晶是非常重要的。",
        ANCIENTDREAMS_SER = "女王陛下可能会赞成这个。",
--
