...
ChangeTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_BLUE,GLOBAL.WORLD_TILES.METEOR)
ChangeMiniMapTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_BLUE,GLOBAL.WORLD_TILES.METEOR)
ChangeTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_BLUE)
ChangeMiniMapTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_BLUE)
ChangeTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_PINK,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED)
ChangeMiniMapTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_PINK,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED)
ChangeTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_GREEN)
ChangeMiniMapTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_RED,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_GREEN)
ChangeTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_GREEN,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_PURPLE)
ChangeMiniMapTileRenderOrder(GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_GREEN,GLOBAL.WORLD_TILES.WHY_CHURCH_TURF_PURPLE)
