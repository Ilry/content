...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_orange.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_orange.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_orange.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_orange.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_orange.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("orangegem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_orange.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_orange")
    inst.AnimState:SetBuild("why_churchstatue_orange")
...
return Prefab("common/objects/why_churchstatue_orange", fn, assets, prefabs),
MakePlacer("why_churchstatue_orange_placer", "why_churchstatue_orange", "why_churchstatue_orange", "placer")