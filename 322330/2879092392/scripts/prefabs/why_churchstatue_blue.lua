...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_blue.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_blue.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_blue.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_blue.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_blue.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("bluegem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_blue.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_blue")
    inst.AnimState:SetBuild("why_churchstatue_blue")
...
return Prefab("common/objects/why_churchstatue_blue", fn, assets, prefabs),
MakePlacer("why_churchstatue_blue_placer", "why_churchstatue_blue", "why_churchstatue_blue", "placer")