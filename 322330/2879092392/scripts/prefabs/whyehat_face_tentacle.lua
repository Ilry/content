local assets = {
    Asset("ANIM", "anim/whyehat_face_tentacle_empty.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_redeye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_blueeye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_purpleeye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_greeneye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_orangeeye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_yelloweye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_opaleye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_perfectioneye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_nothingnesseye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_acorn.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_lureplant.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_plantera.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_desertstone.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_gold.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_marble.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_moonrock.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_flint.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_rock.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_lightbulb.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_glasswhites.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_deerclops.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_yarn.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_milky.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_egg.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_butterfly.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_butterfly_moon.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_winley_eye.zip"),
    Asset("ANIM", "anim/whyehat_face_tentacle_gnarcoon_eye.zip"),
...
local function OnTHFGGiven(inst, giver, item)
    ...
    elseif item.prefab == "moonrocknugget" then
        inst.components.armor:Repair(90)
            ...
            inst.components.container:FindItems(function(item)
                ...
                if owner then
                    ...
                    if item.prefab == "why_refined_redgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_redeye", "swap_hat")
                    ...
                    if item.prefab == "why_refined_bluegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_blueeye", "swap_hat")
                    ...
                    if item.prefab == "why_refined_purplegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_purpleeye", "swap_hat")
                        if owner.components.sanity ~= nil then
                    ...
                    -----------------------------------------------purplegemeye
                    --------------------------------------------------greengemeye ------------------new idea required
                    if item.prefab == "why_refined_greengem" then
                        if not inst:HasTag("greengem_fx") then
                            inst:AddTag("greengem_fx")
                        end
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_greeneye", "swap_hat")
                        terraeye_on(inst)
                    ...
                    if item.prefab == "why_refined_orangegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_orangeeye", "swap_hat")
                        if inst.components.equippable then
                            inst.components.equippable.walkspeedmult = 1.2
                        end
                    ...
                    if item.prefab == "why_refined_yellowgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_yelloweye", "swap_hat")
                        ...
                        owner:WatchWorldState("isday", YellowEyeDmgMultiplier)
                        owner:WatchWorldState("isdusk", RemoveYellowEyeDmgMultiplier)
                    ...
                    if item.prefab == "why_refined_opalgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_opaleye", "swap_hat")
                    ...
                    if item.prefab == "why_perfectiongem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_perfectioneye", "swap_hat")
                    ...
                    if item.prefab == "why_nothingnessgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_nothingnesseye", "swap_hat")
                        ...
                        if inst._shieldready then -- if it's charged without nothingness eye, manually charge
                            ...
                            if owner.components.talker ~= nil then
                                ...
                                elseif TUNING.WHY_LANGUAGE == "chinese" then
                                    owner.components.talker:Say("远古之怒保护着我.")
                                else
                            ...
                            if owner.components.talker ~= nil then
                                ...
                                elseif TUNING.WHY_LANGUAGE == "chinese" then
                                    owner.components.talker:Say("远古的怒意仍在积蓄.")
                                else
                    ...
                    if item.prefab == "acorn" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_acorn", "swap_hat")
                        if owner.components.talker ~= nil then
                            if TUNING.WHY_LANGUAGE == "spanish" then
                    ...
                    if item.prefab == "why_refined_lureplant" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_lureplant", "swap_hat")
                    ...
                    if item.prefab == "why_refined_plantera" then
                        ...
                        terraeye_on(inst)
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_plantera", "swap_hat")
                        if owner.components.health ~= nil then
                            owner.components.health.fire_damage_scale = 2
                            owner.components.health.fire_timestart = .2
                        end
                    ...
                    if item.prefab == "why_refined_desertstone" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_desertstone", "swap_hat")
                    end
                    -----------------------------------------------desertstone
                    --------------------------------------------------gold
                    if item.prefab == "why_refined_gold" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_gold", "swap_hat")
                        if owner.components.builder ~= nil then
                ...
                --------------------------------------------------marble
                    ...
                    owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_marble", "swap_hat")
                ...
                if item.prefab == "why_refined_moonrock" then
                    ...
                    owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_moonrock", "swap_hat")
                end
                    -----------------------------------------------moonrock
                    --------------------------------------------------flint
                    if item.prefab == "why_refined_flint" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_flint", "swap_hat")
                        if owner.components.workmultiplier ~= nil then
                    ...
                    if item.prefab == "rocks" or
                        ...
                        if not inst:HasTag("rock_fx") then
                            owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_rock", "swap_hat")
                            inst:AddTag("rock_fx")
                        end
                    ...
                    if item.prefab == "why_refined_lightbulb" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_lightbulb", "swap_hat")
                    ...
                    if item.prefab == "why_refined_glasswhites" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_glasswhites", "swap_hat")
                    ...
                    if item.prefab == "deerclops_eyeball" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_deerclops", "swap_hat")
                    ...
                    if item.prefab == "trinket_22" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_yarn", "swap_hat")
                    end
                    -----------------------------------------------yarn
                    --------------------------------------------------milky
                    if item.prefab == "why_refined_milky" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_milky", "swap_hat")
                    ...
                    if item.prefab == "why_refined_butterfly" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_butterfly", "swap_hat")
                        if TUNING.WHY_DIFFICULTY == "-1" then
                        ...
                        elseif TUNING.WHY_DIFFICULTY == "1" then
                            inst.butterflyeye = inst:DoPeriodicTask(45, ButterflyEye, nil, owner)
                        end
                    end
                    -----------------------------------------------butterfly
                    --------------------------------------------------butterflymoon
                    if item.prefab == "why_refined_butterfly_moon" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_butterfly_moon", "swap_hat")
                    ...
                    if item.prefab == "bird_egg" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_egg", "swap_hat")
                    end
                    -----------------------------------------------egg
                    --------------------------------------------------winley
                    if item.prefab == "winley_eye" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_winley_eye", "swap_hat")
                    end
                    -----------------------------------------------winley
                    --------------------------------------------------gnarcoon
                    if item.prefab == "gnarcoon_eye" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_gnarcoon_eye", "swap_hat")
                    end
                    -----------------------------------------------gnarcoon
                    --------------------------------------------------passive
                    --------------------------------------------------passive nothing
...
local function removeeye(inst, owner)
    local owner = inst.components.inventoryitem:GetGrandOwner() or nil
    if owner then
        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_tentacle_empty", "swap_hat")
        --------------------------------------------------redgemeye
        ...
        if inst:HasTag("yellowgem_fx") then
            ...
            owner:StopWatchingWorldState("isday", YellowEyeDmgMultiplier)
            owner:StopWatchingWorldState("isdusk", RemoveYellowEyeDmgMultiplier)
...
local function OnEquip(inst, owner)
    ...
    if owner:HasTag("player") then
        owner.whyehat_face_tentacle_task = owner:DoPeriodicTask(0, CheckState)
    end
    placeeye(inst)
    if inst.components.container ~= nil and inst.components.container.canbeopened == true then
...
local function OnUnequip(inst, owner)
    ...
    removeeye(inst)
    if owner.whyehat_face_tentacle_task ~= nil then
        owner.whyehat_face_tentacle_task:Cancel()
        owner.whyehat_face_tentacle_task = nil
    end
...
local function fn()
    ...
    anim:SetBank("whyehat_face_tentacle_empty")
    anim:SetBuild("whyehat_face_tentacle_empty")
    ...
    inst.components.inventoryitem.imagename = "whyehat_face_tentacle"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/whyehat_face_tentacle.xml"
...
return Prefab("common/inventory/whyehat_face_tentacle", fn, assets, prefabs)