...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_green.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_green.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_green.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_green.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_green.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("greengem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_green.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_green")
    inst.AnimState:SetBuild("why_churchstatue_green")
...
return Prefab("common/objects/why_churchstatue_green", fn, assets, prefabs),
MakePlacer("why_churchstatue_green_placer", "why_churchstatue_green", "why_churchstatue_green", "placer")