local assets = {
    Asset("ANIM", "anim/why_redgem_seed.zip"),
    Asset("ANIM", "anim/why_redgem_formation.zip"),
    Asset("ATLAS", "images/map_icons/why_redgem_formation.xml"),
    Asset("IMAGE", "images/map_icons/why_redgem_formation.tex"),
    Asset("ATLAS", "images/inventoryimages/why_redgem_seed.xml"),
    Asset("IMAGE", "images/inventoryimages/why_redgem_seed.tex"),
    Asset("ATLAS_BUILD", "images/inventoryimages/why_redgem_seed.xml",256), }
local function ondeploy(inst, pt, deployer)
    local sapling = SpawnPrefab("why_redgem_formation")
    sapling.components.growable:StartGrowing()
    sapling.Transform:SetPosition(pt:Get())
    sapling.SoundEmitter:PlaySound("dontstarve/wilson/plant_tree")
    inst:Remove()
end
local function redgemseed()
    ...
    inst.AnimState:SetBank("why_redgem_seed")
    inst.AnimState:SetBuild("why_redgem_seed")
    ...
    inst.components.inventoryitem.imagename = "why_redgem_seed"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/why_redgem_seed.xml"
...
local statedata = {
    ...
    { name = "normal",
      ...
      workleft = 6,
      loot = function()
          return math.random() < 0.5 and { "redgem" } or { "redgem", "ancientdreams_gemshard" }
      end, },
    { name = "tall",
      idleanim = "full",
      hitanim = "full_hit",
      ...
      workleft = 8,
      loot = function()
          return { "redgem", "ancientdreams_gemshard", "why_redgem_overgrown" }
      end, }, }
...
local function MakeShrub(name, growthstage)
    ...
    local function fn()
        local inst = CreateEntity()
        inst:SetPrefabName("why_redgem_formation")
        inst.entity:AddTransform()
        inst.entity:AddAnimState()
        inst.entity:AddSoundEmitter()
        inst.entity:AddNetwork()
        ...
        inst.MiniMapEntity:SetIcon("why_redgem_formation.tex")
        inst.MiniMapEntity:SetPriority(5.1)
        inst.AnimState:SetBank("why_redgem_formation")
        inst.AnimState:SetBuild("why_redgem_formation")
        inst.AnimState:PlayAnimation("why_redgem_sapling")
...
return Prefab("why_redgem_seed", redgemseed, assets),
MakePlacer("why_redgem_seed_placer", "why_redgem_formation", "why_redgem_formation", "why_redgem_sapling"),
MakeShrub("why_redgem_formation"),
MakeShrub("why_redgem_formation_short", 1),
MakeShrub("why_redgem_formation_normal", 2),
MakeShrub("why_redgem_formation_tall", 3)