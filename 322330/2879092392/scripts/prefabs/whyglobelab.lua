...
local assets = {
    Asset("ANIM", "anim/whyglobelab.zip"),
    Asset("ATLAS", "images/inventoryimages/whyglobelab.xml"),
    Asset("IMAGE", "images/inventoryimages/whyglobelab.tex"),
    Asset("ATLAS", "images/map_icons/whyglobelabmap.xml"),
    Asset("IMAGE", "images/map_icons/whyglobelabmap.tex"), }
...
local function MakePrototyper(inst)
    if not inst.components.prototyper and inst.is_already_built ~= nil then
        ...
        inst.components.prototyper.trees = TUNING.PROTOTYPER_TREES.GLOBEDREAM_ONE
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("whyglobelabmap.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("whyglobelab")
    inst.AnimState:SetBuild("whyglobelab")
...
return Prefab("common/objects/whyglobelab", fn, assets, prefabs),
MakePlacer("whyglobelab_placer", "whyglobelab", "whyglobelab", "whyglobelab_placer")