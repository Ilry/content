local assets = {
    Asset("ANIM", "anim/why_greengem_seed.zip"),
    Asset("ANIM", "anim/why_greengem_formation.zip"),
    Asset("ATLAS", "images/map_icons/why_greengem_formation.xml"),
    Asset("IMAGE", "images/map_icons/why_greengem_formation.tex"),
    Asset("ATLAS", "images/inventoryimages/why_greengem_seed.xml"),
    Asset("IMAGE", "images/inventoryimages/why_greengem_seed.tex"),
    Asset("ATLAS_BUILD", "images/inventoryimages/why_greengem_seed.xml",256), }
local function ondeploy(inst, pt, deployer)
    local sapling = SpawnPrefab("why_greengem_formation")
    sapling.components.growable:StartGrowing()
    sapling.Transform:SetPosition(pt:Get())
    sapling.SoundEmitter:PlaySound("dontstarve/wilson/plant_tree")
    inst:Remove()
end
local function greengemseed()
    ...
    inst.AnimState:SetBank("why_greengem_seed")
    inst.AnimState:SetBuild("why_greengem_seed")
    ...
    inst.components.inventoryitem.imagename = "why_greengem_seed"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/why_greengem_seed.xml"
...
local statedata = {
    ...
    { name = "normal",
      ...
      workleft = 6,
      loot = function()
          return math.random() < 0.5 and { "greengem" } or { "greengem", "ancientdreams_gemshard" }
      end, },
    { name = "tall",
      idleanim = "full",
      hitanim = "full_hit",
      ...
      workleft = 8,
      loot = function()
          return { "greengem", "ancientdreams_gemshard", "why_greengem_overgrown" }
      end, }, }
...
local function MakeShrub(name, growthstage)
    ...
    local function fn()
        local inst = CreateEntity()
        inst:SetPrefabName("why_greengem_formation")
        inst.entity:AddTransform()
        inst.entity:AddAnimState()
        inst.entity:AddSoundEmitter()
        inst.entity:AddNetwork()
        ...
        inst.MiniMapEntity:SetIcon("why_greengem_formation.tex")
        inst.MiniMapEntity:SetPriority(5.4)
        inst.AnimState:SetBank("why_greengem_formation")
        inst.AnimState:SetBuild("why_greengem_formation")
        inst.AnimState:PlayAnimation("why_greengem_sapling")
...
return Prefab("why_greengem_seed", greengemseed, assets),
MakePlacer("why_greengem_seed_placer", "why_greengem_formation", "why_greengem_formation", "why_greengem_sapling"),
MakeShrub("why_greengem_formation"),
MakeShrub("why_greengem_formation_short", 1),
MakeShrub("why_greengem_formation_normal", 2),
MakeShrub("why_greengem_formation_tall", 3)