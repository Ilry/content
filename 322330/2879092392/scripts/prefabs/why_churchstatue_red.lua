...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_red.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_red.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_red.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_red.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_red.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("redgem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_red.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_red")
    inst.AnimState:SetBuild("why_churchstatue_red")
...
return Prefab("common/objects/why_churchstatue_red", fn, assets, prefabs),
MakePlacer("why_churchstatue_red_placer", "why_churchstatue_red", "why_churchstatue_red", "placer")