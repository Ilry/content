...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_opal.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_opal.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_opal.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_opal.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_opal.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("opalpreciousgem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_opal.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_opal")
    inst.AnimState:SetBuild("why_churchstatue_opal")
...
return Prefab("common/objects/why_churchstatue_opal", fn, assets, prefabs),
MakePlacer("why_churchstatue_opal_placer", "why_churchstatue_opal", "why_churchstatue_opal", "placer")