...
local assets = {
    Asset("ANIM", "anim/why_churchstatue_yellow.zip"),
    Asset("ATLAS", "images/inventoryimages/why_churchstatue_yellow.xml"),
    Asset("IMAGE", "images/inventoryimages/why_churchstatue_yellow.tex"),
    Asset("ATLAS", "images/map_icons/why_churchstatue_yellow.xml"),
    Asset("IMAGE", "images/map_icons/why_churchstatue_yellow.tex"), }
...
local function onhammered(inst, worker)
	...
	SpawnPrefab("yellowgem", 5, 5, 5, 5).Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function fn()
    ...
    inst.entity:AddMiniMapEntity()
    inst.MiniMapEntity:SetIcon("why_churchstatue_yellow.tex")
    inst.MiniMapEntity:SetPriority(5)
    inst.AnimState:SetBank("why_churchstatue_yellow")
    inst.AnimState:SetBuild("why_churchstatue_yellow")
...
return Prefab("common/objects/why_churchstatue_yellow", fn, assets, prefabs),
MakePlacer("why_churchstatue_yellow_placer", "why_churchstatue_yellow", "why_churchstatue_yellow", "placer")