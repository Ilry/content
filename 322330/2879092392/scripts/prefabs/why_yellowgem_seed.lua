local assets = {
    Asset("ANIM", "anim/why_yellowgem_seed.zip"),
    Asset("ANIM", "anim/why_yellowgem_formation.zip"),
    Asset("ATLAS", "images/map_icons/why_yellowgem_formation.xml"),
    Asset("IMAGE", "images/map_icons/why_yellowgem_formation.tex"),
    Asset("ATLAS", "images/inventoryimages/why_yellowgem_seed.xml"),
    Asset("IMAGE", "images/inventoryimages/why_yellowgem_seed.tex"),
    Asset("ATLAS_BUILD", "images/inventoryimages/why_yellowgem_seed.xml",256), }
local function ondeploy(inst, pt, deployer)
    local sapling = SpawnPrefab("why_yellowgem_formation")
    sapling.components.growable:StartGrowing()
    sapling.Transform:SetPosition(pt:Get())
    sapling.SoundEmitter:PlaySound("dontstarve/wilson/plant_tree")
    inst:Remove()
end
local function yellowgemseed()
    ...
    inst.AnimState:SetBank("why_yellowgem_seed")
    inst.AnimState:SetBuild("why_yellowgem_seed")
    ...
    inst.components.inventoryitem.imagename = "why_yellowgem_seed"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/why_yellowgem_seed.xml"
...
local statedata = {
    { name = "short",
      idleanim = "why_yellowgem_sapling",
        --hitanim     = "hit_short",
    ...
    { name = "normal",
      ...
      workleft = 6,
      loot = function()
          return math.random() < 0.5 and { "yellowgem" } or { "yellowgem", "ancientdreams_gemshard" }
      end, },
    { name = "tall",
      idleanim = "full",
      hitanim = "full_hit",
      ...
      workleft = 8,
      loot = function()
          return { "yellowgem", "ancientdreams_gemshard", "why_yellowgem_overgrown" }
      end, }, }
...
local function MakeShrub(name, growthstage)
    ...
    local function fn()
        local inst = CreateEntity()
        inst:SetPrefabName("why_yellowgem_formation")
        inst.entity:AddTransform()
        inst.entity:AddAnimState()
        inst.entity:AddSoundEmitter()
        inst.entity:AddNetwork()
        ...
        inst.MiniMapEntity:SetIcon("why_yellowgem_formation.tex")
        inst.MiniMapEntity:SetPriority(5.6)
        inst.AnimState:SetBank("why_yellowgem_formation")
        inst.AnimState:SetBuild("why_yellowgem_formation")
        inst.AnimState:PlayAnimation("why_yellowgem_sapling")
...
return Prefab("why_yellowgem_seed", yellowgemseed, assets),
MakePlacer("why_yellowgem_seed_placer", "why_yellowgem_formation", "why_yellowgem_formation", "why_yellowgem_sapling"),
MakeShrub("why_yellowgem_formation"),
MakeShrub("why_yellowgem_formation_short", 1),
MakeShrub("why_yellowgem_formation_normal", 2),
MakeShrub("why_yellowgem_formation_tall", 3)