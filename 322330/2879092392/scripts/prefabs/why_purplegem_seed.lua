local assets = {
    Asset("ANIM", "anim/why_purplegem_seed.zip"),
    Asset("ANIM", "anim/why_purplegem_formation.zip"),
    Asset("ATLAS", "images/map_icons/why_purplegem_formation.xml"),
    Asset("IMAGE", "images/map_icons/why_purplegem_formation.tex"),
    Asset("ATLAS", "images/inventoryimages/why_purplegem_seed.xml"),
    Asset("IMAGE", "images/inventoryimages/why_purplegem_seed.tex"),
    Asset("ATLAS_BUILD", "images/inventoryimages/why_purplegem_seed.xml",256), }
local function ondeploy(inst, pt, deployer)
    local sapling = SpawnPrefab("why_purplegem_formation")
    sapling.components.growable:StartGrowing()
    sapling.Transform:SetPosition(pt:Get())
    sapling.SoundEmitter:PlaySound("dontstarve/wilson/plant_tree")
    inst:Remove()
end
local function purplegemseed()
    ...
    inst.AnimState:SetBank("why_purplegem_seed")
    inst.AnimState:SetBuild("why_purplegem_seed")
    ...
    inst.components.inventoryitem.imagename = "why_purplegem_seed"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/why_purplegem_seed.xml"
...
local statedata = {
    { name = "short",
      idleanim = "why_purplegem_sapling",
        --hitanim     = "hit_short",
    ...
    { name = "normal",
      ...
      workleft = 6,
      loot = function()
          return math.random() < 0.5 and { "purplegem" } or { "purplegem", "ancientdreams_gemshard" }
      end, },
    { name = "tall",
      idleanim = "full",
      hitanim = "full_hit",
      ...
      workleft = 8,
      loot = function()
          return { "purplegem", "ancientdreams_gemshard", "why_purplegem_overgrown" }
      end, }, }
...
local function MakeShrub(name, growthstage)
    ...
    local function fn()
        local inst = CreateEntity()
        inst:SetPrefabName("why_purplegem_formation")
        inst.entity:AddTransform()
        inst.entity:AddAnimState()
        inst.entity:AddSoundEmitter()
        inst.entity:AddNetwork()
        ...
        inst.MiniMapEntity:SetIcon("why_purplegem_formation.tex")
        inst.MiniMapEntity:SetPriority(5.3)
        inst.AnimState:SetBank("why_purplegem_formation")
        inst.AnimState:SetBuild("why_purplegem_formation")
        inst.AnimState:PlayAnimation("why_purplegem_sapling")
...
return Prefab("why_purplegem_seed", purplegemseed, assets),
MakePlacer("why_purplegem_seed_placer", "why_purplegem_formation", "why_purplegem_formation", "why_purplegem_sapling"),
MakeShrub("why_purplegem_formation"),
MakeShrub("why_purplegem_formation_short", 1),
MakeShrub("why_purplegem_formation_normal", 2),
MakeShrub("why_purplegem_formation_tall", 3)