local assets = {
    Asset("ANIM", "anim/whyehat_face_demon_empty.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_redeye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_blueeye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_purpleeye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_greeneye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_orangeeye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_yelloweye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_opaleye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_perfectioneye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_nothingnesseye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_acorn.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_lureplant.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_plantera.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_desertstone.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_gold.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_marble.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_moonrock.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_flint.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_rock.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_lightbulb.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_glasswhites.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_deerclops.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_yarn.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_milky.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_egg.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_butterfly.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_butterfly_moon.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_winley_eye.zip"),
    Asset("ANIM", "anim/whyehat_face_demon_gnarcoon_eye.zip"),
            ...
            inst.components.container:FindItems(function(item)
                ...
                if owner then
                    ...
                    if item.prefab == "why_refined_redgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_redeye", "swap_hat")
                    ...
                    if item.prefab == "why_refined_bluegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_blueeye", "swap_hat")
                    ...
                    if item.prefab == "why_refined_purplegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_purpleeye", "swap_hat")
                        if owner.components.sanity ~= nil then
                    ...
                    if item.prefab == "why_refined_greengem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_greeneye", "swap_hat")
                        terraeye_on(inst)
                    ...
                    if item.prefab == "why_refined_orangegem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_orangeeye", "swap_hat")
                        if inst.components.equippable then
                            inst.components.equippable.walkspeedmult = 1.2
                        end
                    ...
                    if item.prefab == "why_refined_yellowgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_yelloweye", "swap_hat")
                    ...
                    if item.prefab == "why_refined_opalgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_opaleye", "swap_hat")
                    ...
                    if item.prefab == "why_perfectiongem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_perfectioneye", "swap_hat")
                    ...
                    if item.prefab == "why_nothingnessgem" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_nothingnesseye", "swap_hat")
                    ...
                    if item.prefab == "acorn" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_acorn", "swap_hat")
                        if owner.components.talker ~= nil then
                            if TUNING.WHY_LANGUAGE == "spanish" then
                    ...
                    if item.prefab == "why_refined_lureplant" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_lureplant", "swap_hat")
                    ...
                    if item.prefab == "why_refined_plantera" then
                        ...
                        terraeye_on(inst)
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_plantera", "swap_hat")
                        if owner.components.health ~= nil then
                            owner.components.health.fire_damage_scale = 2
                            owner.components.health.fire_timestart = .2
                        end
                    ...
                    if item.prefab == "why_refined_desertstone" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_desertstone", "swap_hat")
                    end
                    -----------------------------------------------desertstone
                    --------------------------------------------------gold
                    if item.prefab == "why_refined_gold" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_gold", "swap_hat")
                        if owner.components.builder ~= nil then
                ...
                --------------------------------------------------marble
                    ...
                    owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_marble", "swap_hat")
                ...
                if item.prefab == "why_refined_moonrock" then
                    ...
                    owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_moonrock", "swap_hat")
                end
                    -----------------------------------------------moonrock
                    --------------------------------------------------flint
                    if item.prefab == "why_refined_flint" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_flint", "swap_hat")
                        if owner.components.workmultiplier ~= nil then
                    ...
                    if item.prefab == "rocks" or
                        ...
                        if not inst:HasTag("rock_fx") then
                            owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_rock", "swap_hat")
                            inst:AddTag("rock_fx")
                        end
                    ...
                    if item.prefab == "why_refined_lightbulb" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_lightbulb", "swap_hat")
                    ...
                    if item.prefab == "why_refined_glasswhites" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_glasswhites", "swap_hat")
                    ...
                    if item.prefab == "deerclops_eyeball" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_deerclops", "swap_hat")
                    ...
                    if item.prefab == "trinket_22" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_yarn", "swap_hat")
                    end
                    -----------------------------------------------yarn
                    --------------------------------------------------milky
                    if item.prefab == "why_refined_milky" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_milky", "swap_hat")
                    ...
                    if item.prefab == "why_refined_butterfly" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_butterfly", "swap_hat")
                        if TUNING.WHY_DIFFICULTY == "-1" then
                    ...
                    if item.prefab == "why_refined_butterfly_moon" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_butterfly_moon", "swap_hat")
                    ...
                    if item.prefab == "bird_egg" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_egg", "swap_hat")
                    end
                    -----------------------------------------------egg
                    --------------------------------------------------winley
                    if item.prefab == "winley_eye" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_winley_eye", "swap_hat")
                    end
                    -----------------------------------------------winley
                    --------------------------------------------------gnarcoon
                    if item.prefab == "gnarcoon_eye" then
                        ...
                        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_gnarcoon_eye", "swap_hat")
                    end
                    -----------------------------------------------gnarcoon
                    --------------------------------------------------passive
                    --------------------------------------------------passive nothing
...
local function removeeye(inst, owner)
    local owner = inst.components.inventoryitem:GetGrandOwner() or nil
    if owner then
        owner.AnimState:OverrideSymbol("swap_hat", "whyehat_face_demon_empty", "swap_hat")
        --------------------------------------------------redgemeye
...
local function OnEquip(inst, owner)
    ...
    if owner:HasTag("player") then
        owner.whyehat_face_demon_task = owner:DoPeriodicTask(0, CheckState)
    end
    placeeye(inst)
    if inst.components.container ~= nil and inst.components.container.canbeopened == true then
...
local function OnUnequip(inst, owner)
    ...
    removeeye(inst)
    if owner.whyehat_face_demon_task ~= nil then
        owner.whyehat_face_demon_task:Cancel()
        owner.whyehat_face_demon_task = nil
    end
...
local function fn()
    ...
    anim:SetBank("whyehat_face_demon_empty")
    anim:SetBuild("whyehat_face_demon_empty")
    ...
    inst.components.inventoryitem.imagename = "whyehat_face_demon"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/whyehat_face_demon.xml"
...
return Prefab("common/inventory/whyehat_face_demon", fn, assets, prefabs)