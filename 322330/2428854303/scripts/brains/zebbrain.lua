...
local ZebBrain = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)

function ZebBrain:OnStart()
    local root =
    PriorityNode(
    {
        WhileNode( function() return self.inst.components.health.takingfiredamage end, "OnFire", Panic(self.inst)),
        -- IfNode( function() return self.inst.components.combat.target ~= nil end, "hastarget", AttackWall(self.inst)), -- Don't target walls.
...
function ZebBrain:OnInitializationComplete()
