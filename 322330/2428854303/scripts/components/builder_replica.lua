...
function Builder:CanBuildAtPoint(pt, recipe, rot)
	...
	local position0 = TheWorld.Map:GetTile(TheWorld.Map:GetTileCoordsAtPoint(ex,   ey, ez))
	local position1 = TheWorld.Map:GetTile(TheWorld.Map:GetTileCoordsAtPoint(ex,   ey, ez+2))
	local position2 = TheWorld.Map:GetTile(TheWorld.Map:GetTileCoordsAtPoint(ex,   ey, ez-2))
	local position3 = TheWorld.Map:GetTile(TheWorld.Map:GetTileCoordsAtPoint(ex+2, ey, ez))
