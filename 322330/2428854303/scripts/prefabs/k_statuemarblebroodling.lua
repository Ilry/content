...
return Prefab("kyno_statuemarblebroodling", fn, assets, prefabs),
MakePlacer("kyno_statuemarblebroodling_placer", "statuemarblebroodling", "statuemarblebroodling", "idle")