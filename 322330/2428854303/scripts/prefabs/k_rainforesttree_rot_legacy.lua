...
local builds =
{
	normal = {
		...
		prefab_name="rainforesttreelegacy_rot",
...
return tree("rainforesttreelegacy_rot", "normal", 0),
tree("rainforesttreelegacy_rot_normal", "normal", 2),
tree("rainforesttreelegacy_rot_tall", "normal", 3),
tree("rainforesttreelegacy_rot_short", "normal", 1),
tree("rainforesttreelegacy_rot_burnt", "normal", 0, "burnt"),
tree("rainforesttreelegacy_rot_stump", "normal", 0, "stump"),
MakePlacer("rainforesttreelegacy_rot_short_placer", "jungletree", "tree_forest_rot_build", "idle_short")