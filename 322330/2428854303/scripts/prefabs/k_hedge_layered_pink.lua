...
function MakeHedgeType(data)
    local assets =
    {
		...
		Asset("ANIM", "anim/hedge3_pink_build.zip"),
    ...
    local function ondeploywall(inst, pt, deployer)
        local wall = SpawnPrefab("hedge_layered_pink") 
        if wall ~= nil then 
    ...
    local function itemfn()
        ...
        inst.AnimState:SetBuild("hedge3_pink_build")
		...
		inst.components.inspectable.nameoverride = "HEDGE_LAYERED_ITEM"
    ...
    local function fn()
        ...
        inst:AddComponent("inspectable")
		inst.components.inspectable.nameoverride = "HEDGE_LAYERED"
    ...
    return Prefab("hedge_layered_pink", fn, assets, prefabs),
	Prefab("hedge_layered_pink_item", itemfn, assets, {"hedge_layered_pink_item_placer", "collapse_small"}),
	MakePlacer("hedge_layered_pink_item_placer", "hedge", "hedge3_pink_build", "growth1", false, false, true, nil, nil, "eight")
end
