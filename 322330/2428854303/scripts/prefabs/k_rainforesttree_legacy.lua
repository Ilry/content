...
local builds =
{
	normal = {
		...
		prefab_name="rainforesttreelegacy",
...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
		...
		minimap:SetIcon("kyno_jungletree.tex")
...
return tree("rainforesttreelegacy", "normal", 0),
tree("rainforesttreelegacy_normal", "normal", 2),
tree("rainforesttreelegacy_tall", "normal", 3),
tree("rainforesttreelegacy_short", "normal", 1),
tree("rainforesttreelegacy_burnt", "normal", 0, "burnt"),
tree("rainforesttreelegacy_stump", "normal", 0, "stump"),
MakePlacer("rainforesttreelegacy_short_placer", "jungletree", "tree_forest_build", "idle_short")