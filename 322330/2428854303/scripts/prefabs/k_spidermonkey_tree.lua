...
local function SetStage(inst, stage, skip_anim)
    if stage <= 1 and inst.components.childspawner ~= nil then -- if childspawner doesn't exist, then this den is burning down
...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
		...
		inst:SetPrefabNameOverride("cocoonedtree")
...
return tree("spidermonkeytree", "normal", 0),
tree("spidermonkeytree_normal", "normal", 2),
tree("spidermonkeytree_tall", "normal", 3),
tree("spidermonkeytree_short", "normal", 1),
tree("spidermonkeytree_burnt", "normal", 0, "burnt"),
tree("spidermonkeytree_stump", "normal", 0, "stump"),
MakePlacer("spidermonkeytree_short_placer", "rainforesttree", "tree_rainforest_web_build", "idle_short")