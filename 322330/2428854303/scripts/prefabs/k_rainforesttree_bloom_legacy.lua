...
{
	normal = {
		file="tree_forest_bloom_build",
		prefab_name="rainforesttreelegacy_bloom",
...
return tree("rainforesttreelegacy_bloom", "normal", 0),
tree("rainforesttreelegacy_bloom_normal", "normal", 2),
tree("rainforesttreelegacy_bloom_tall", "normal", 3),
tree("rainforesttreelegacy_bloom_short", "normal", 1),
tree("rainforesttreelegacy_bloom_burnt", "normal", 0, "burnt"),
tree("rainforesttreelegacy_bloom_stump", "normal", 0, "stump"),
MakePlacer("rainforesttreelegacy_bloom_short_placer", "jungletree", "tree_forest_bloom_build", "idle_short")