...
local builds =
{
	normal = {
		...
		prefab_name="rainforesttreelegacy2",
...
return tree("rainforesttreelegacy2", "normal", 0),
tree("rainforesttreelegacy2_normal", "normal", 2),
tree("rainforesttreelegacy2_tall", "normal", 3),
tree("rainforesttreelegacy2_short", "normal", 1),
tree("rainforesttreelegacy2_burnt", "normal", 0, "burnt"),
tree("rainforesttreelegacy2_stump", "normal", 0, "stump"),
MakePlacer("rainforesttreelegacy2_short_placer", "jungletree", "tree_forest_deep_build", "idle_short")