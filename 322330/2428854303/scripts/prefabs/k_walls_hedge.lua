...
function MakeWallType(data)
    ...
    local function itemfn()
        ...
        inst.components.repairer.repairmaterial = (data.name == "hedge_block" and MATERIALS.HAY)
		or (data.name == "hedge_cone" and MATERIALS.HAY) or (data.name == "hedge_layered" and MATERIALS.HAY) or data.name
    ...
    local function fn()
		...
		inst.components.repairable.repairmaterial = (data.name == "hedge_block" and MATERIALS.HAY)
		or (data.name == "hedge_cone" and MATERIALS.HAY) or (data.name == "hedge_layered" and MATERIALS.HAY) or data.name
...
local walldata =
{
    { name = "hedge_block",   material = "straw", tags = { "grass", "hedge1" }, loot = "cutgrass", maxloots = 2, maxhealth = TUNING.HAYWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
	{ name = "hedge_cone",    material = "straw", tags = { "grass", "hedge2" }, loot = "cutgrass", maxloots = 2, maxhealth = TUNING.HAYWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
	{ name = "hedge_layered", material = "straw", tags = { "grass", "hedge3" }, loot = "cutgrass", maxloots = 2, maxhealth = TUNING.HAYWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
