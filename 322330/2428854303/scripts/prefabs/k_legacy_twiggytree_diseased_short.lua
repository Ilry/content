...
local function OnTimerDone(inst, data)
    if data.name == "grow" then
		...
		inst:ListenForEvent("animover", function() SpawnPrefab("kyno_legacytwiggy_diseased_normal").Transform:SetPosition(inst.Transform:GetWorldPosition()) end)
    end
end
...
return Prefab("kyno_legacytwiggy_diseased_short", fn, assets, prefabs),
MakePlacer("kyno_legacytwiggy_diseased_short_placer", "twiggy_diseased_short_normal", "legacy_twiggytree_diseased_short_normal", "sway1_loop_short", false, nil, nil, nil, nil, nil, twiggyplacefn)