...
local function moon_mush()
	...
	inst:SetPrefabNameOverride("mushtree_moon")
...
Prefab("kyno_stump9", moon_mush, assets, prefabs),
MakePlacer("kyno_stump9_placer", "mushroom_tree", "mutatedmushroom_tree_build", "idle_stump")