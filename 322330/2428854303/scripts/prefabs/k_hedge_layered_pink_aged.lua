...
function MakeHedgeType(data)
    ...
    local function ondeploywall(inst, pt, deployer)
        local wall = SpawnPrefab("hedge_layered_pink_aged") 
        if wall ~= nil then 
    ...
    local function itemfn()
		...
		inst.components.inspectable.nameoverride = "HEDGE_LAYERED_AGED_ITEM"
...
local hedgedata =
{   
    { name = "hedge_layered_pink_aged", hedgetype = 1, material = "foliage", tags = { "hedge" }, loot = "foliage", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
