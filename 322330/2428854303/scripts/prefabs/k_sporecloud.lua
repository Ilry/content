...
local AURA_EXCLUDE_TAGS = { "gasmasked", "toadstool", "playerghost", "ghost", "shadow", "shadowminion", "noauradamage", "INLIMBO", "notarget", "noattack", "flight", "invisible" }
...
local function dig_up(inst, chopper)
	...
	SpawnPrefab("spore_small").Transform:SetPosition(inst.Transform:GetWorldPosition())
end
