...
function MakeHedgeType(data)
    ...
    local function ondeploywall(inst, pt, deployer)
        local wall = SpawnPrefab("hedge_cone_pink") 
        if wall ~= nil then 
    ...
    local function itemfn()
		...
		inst.components.inspectable.nameoverride = "HEDGE_CONE_ITEM"
    ...
    local function fn()
        ...
        inst:AddComponent("inspectable")
		inst.components.inspectable.nameoverride = "HEDGE_CONE"
    ...
    return Prefab("hedge_cone_pink", fn, assets, prefabs),
	Prefab("hedge_cone_pink_item", itemfn, assets, {"hedge_cone_pink_placer", "collapse_small"}),
	MakePlacer("hedge_cone_pink_item_placer", "hedge", "hedge2_pink_build", "growth1", false, false, true, nil, nil, "eight")
end

local hedgeprefabs = {}
local hedgedata =
{   
    { name = "hedge_cone_pink", hedgetype = 1, material = "foliage", tags = { "hedge" }, loot = "foliage", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
