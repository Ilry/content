...
function MakeHedgeType(data)
    local assets =
    {
		...
		Asset("ANIM", "anim/hedge2_pink_build.zip"),
    ...
    local function ondeploywall(inst, pt, deployer)
        local wall = SpawnPrefab("hedge_cone_pink_aged") 
        if wall ~= nil then 
    ...
    local function itemfn()
        ...
        inst.AnimState:SetBuild("hedge2_pink_build")
		...
		inst.components.inspectable.nameoverride = "HEDGE_CONE_AGED_ITEM"
    ...
    local function fn()
        ...
        inst:AddComponent("inspectable")
		inst.components.inspectable.nameoverride = "HEDGE_CONE_AGED"
    ...
    return Prefab("hedge_cone_pink_aged", fn, assets, prefabs),
	Prefab("hedge_cone_pink_aged_item", itemfn, assets, {"hedge_cone_pink_aged_item_placer", "collapse_small"}),
	MakePlacer("hedge_cone_pink_aged_item_placer", "hedge", "hedge2_pink_build", "growth2", false, false, true, nil, nil, "eight")
end

local hedgeprefabs = {}
local hedgedata =
{   
    { name = "hedge_cone_pink_aged", hedgetype = 1, material = "foliage", tags = { "hedge" }, loot = "foliage", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
