...
function MakeHedgeType(data)
    ...
    local function ondeploywall(inst, pt, deployer)
        local wall = SpawnPrefab("hedge_block_pink") 
        if wall ~= nil then 
    ...
    local function itemfn()
		...
		inst.components.inspectable.nameoverride = "HEDGE_BLOCK_ITEM"
    ...
    local function fn()
        ...
        inst:AddComponent("inspectable")
		inst.components.inspectable.nameoverride = "HEDGE_BLOCK"
    ...
    return Prefab("hedge_block_pink", fn, assets, prefabs),
	Prefab("hedge_block_pink_item", itemfn, assets, {"hedge_block_pink_item_placer", "collapse_small"}),
	MakePlacer("hedge_block_pink_item_placer", "hedge", "hedge1_pink_build", "growth1", false, false, true, nil, nil, "eight")
end

local hedgeprefabs = {}
local hedgedata =
{   
    { name = "hedge_block_pink", hedgetype = 1, material = "foliage", tags = { "hedge" }, loot = "foliage", maxloots = 2, maxhealth = TUNING.STONEWALL_HEALTH, buildsound = "dontstarve/common/place_structure_straw" },
}
