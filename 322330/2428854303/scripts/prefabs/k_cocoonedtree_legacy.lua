...
local builds =
{
	normal = {
		...
		prefab_name="cocoonedtreelegacy",
...
return tree("cocoonedtreelegacy", "normal", 0),
tree("cocoonedtreelegacy_normal", "normal", 2),
tree("cocoonedtreelegacy_tall", "normal", 3),
tree("cocoonedtreelegacy_short", "normal", 1),
tree("cocoonedtreelegacy_burnt", "normal", 0, "burnt"),
tree("cocoonedtreelegacy_stump", "normal", 0, "stump"),
MakePlacer("cocoonedtreelegacy_short_placer", "rainforesttree", "tree_rainforest_webbed_build", "idle_short")