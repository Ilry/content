...
local function fn()
	...
	-- inst.components.lootdropper:SetLoot({"twiggy_nut", "log"})
...
return Prefab("kyno_legacytwiggy_diseased_old", fn, assets, prefabs),
MakePlacer("kyno_legacytwiggy_diseased_old_placer", "twiggy_diseased_tall_old", "legacy_twiggytree_diseased_tall_old", "idle_old", false, nil, nil, nil, nil, nil, twiggyplacefn)