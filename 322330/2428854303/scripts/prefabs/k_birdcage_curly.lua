...
local assets =
{
	...
	Asset("ANIM", "anim/hutch_pigeon_build.zip"),
...
local function fn()
    ...
    minimap:SetIcon("kyno_birdcage_curly.tex")

    inst.AnimState:SetBank("birdcage")
    inst.AnimState:SetBuild("hutch_pigeon_build")
	...
	inst.components.inspectable.nameoverride = "BIRDCAGE"
...
return Prefab("kyno_birdcage_curly", fn, assets, prefabs),
MakePlacer("kyno_birdcage_curly_placer", "birdcage", "hutch_pigeon_build", "idle_empty")