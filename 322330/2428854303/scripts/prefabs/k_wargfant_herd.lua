...
local function fn()
    ...
    inst.components.herd:SetMemberTag("wargfant")
	inst.components.herd:SetMaxSize(1)
    ...
    inst.components.periodicspawner:SetPrefab("kyno_wargfant")
...
return Prefab("kyno_wargfant_herd", fn, nil, prefabs)