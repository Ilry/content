local assets =
{
	...
	Asset("ANIM", "anim/tree_spider_webs_build.zip"),
...
{
	normal = {
		file="tree_spider_webs_build",
		prefab_name="cocoonedtreelegacy2",
...
local function makefn(build, stage, data)
	...
	local function fn(Sim)
		...
		minimap:SetIcon("kyno_cocoonedtree.tex")
...
return tree("cocoonedtreelegacy2", "normal", 0),
tree("cocoonedtreelegacy2_normal", "normal", 2),
tree("cocoonedtreelegacy2_tall", "normal", 3),
tree("cocoonedtreelegacy2_short", "normal", 1),
tree("cocoonedtreelegacy2_burnt", "normal", 0, "burnt"),
tree("cocoonedtreelegacy2_stump", "normal", 0, "stump"),
MakePlacer("cocoonedtreelegacy2_short_placer", "jungletree", "tree_spider_webs_build", "idle_short")