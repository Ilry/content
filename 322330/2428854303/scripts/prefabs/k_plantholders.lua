...
MakePlacer("kyno_plantholder_basic_placer", "interior_plant", "interior_plant", "plant_basic", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_bonsai_placer", "interior_plant", "interior_plant", "plant_bonsai", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_dishgarden_placer", "interior_plant", "interior_plant", "plant_dishgarden", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_draceana_placer", "interior_plant", "interior_plant", "plant_draceana", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_fancy_placer", "interior_plant", "interior_plant", "plant_fancy", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_fernstand_placer", "interior_plant", "interior_plant", "plant_fernstand", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_orchid_placer", "interior_plant", "interior_plant", "plant_orchid", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_palm_placer", "interior_plant", "interior_plant", "plant_palm", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_philodendron_placer", "interior_plant", "interior_plant", "plant_philodendron", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_plantpet_placer", "interior_plant", "interior_plant", "plant_plantpet", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_terrarium_placer", "interior_plant", "interior_plant", "plant_terrarium", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_traps_placer", "interior_plant", "interior_plant", "plant_traps", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_sadness_placer", "interior_plant", "interior_plant", "plant_winterfeasttreeofsadness", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_wip_placer", "interior_plant", "interior_plant", "plant_wip", nil, nil, nil, nil, nil, "two", plantholderplacefn),
MakePlacer("kyno_plantholder_zz_placer", "interior_plant", "interior_plant", "plant_zz", nil, nil, nil, nil, nil, "two", plantholderplacefn)