...
{   
	...
	State{
		...
		timeline = 
		{
			TimeEvent( 1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/baby_doy_doy/eat_pre") end),
			TimeEvent(11*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/baby_doy_doy/swallow") end),
		},
	},
	...
	State{
		...
		onenter = function(inst)
			...
			inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/baby_doy_doy/hatch")
	...
	{ 
		...
		TimeEvent(1*FRAMES, function(inst)
			if inst:HasTag("baby") then
				...
				inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/baby_doy_doy/jump")
			end
		end),
	}
}, nil, true)
CommonStates.AddCombatStates(states,
{
	...
	deathtimeline = 
	{
		TimeEvent(FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/baby_doy_doy/death") end)
	},
})
