...
configuration_options =
{
    ...
    },
    {
        ...
        options =
        {
            {description = Ch and "开" or "On", data = true, hover = Ch and "掉落相同的物品会自动堆叠在一起" or "Auto stack the same items on the ground."},
            {description = Ch and "关" or "Off", data = false, hover = Ch and "掉落相同的物品不会自动堆叠" or "Nothing will happen."}
        },
        default = true
    },
    {
    ...
    },
    {
        ...
        options = 
        {	
            {description = Ch and "开启A" or "On_A", data = "A", hover = Ch and  "此配置下可堆叠小兔子、鼹鼠、鸟类、蜘蛛类等等，包括高鸟蛋和岩浆虫卵" or ""},
            {description = Ch and "开启B" or "On_B", data = "B",hover = Ch and  "此配置下可堆叠小兔子、鼹鼠、鸟类、蜘蛛类等等，不包括高鸟蛋和岩浆虫卵" or ""},
    ...
    },
    {
        ...
        options =
        {
            {description = Ch and "开" or "On", data = true, hover = Ch and "每过 N 天自动清理服务器无用物品" or "All servers clean every N days"},
            {description = Ch and "关" or "Off", data = false, hover = Ch and "啥事儿都不发生" or "Nothing will happen."}
        },
        default = true
    },
    {
    ...
    },
    {
        ...
        options =
        {
            {description = Ch and "关" or "Off", data = false},
            {description = Ch and "开" or "On", data = true}
        },
        default = false
    },
    {
        ...
        options =
        {
            {description = Ch and "开" or "On", data = true, hover = Ch and "测试模式开，清理周期变为10秒一次" or "Test mode on, clean cycle = 10s."},
            {description = Ch and "关" or "Off", data = false, hover = Ch and "测试模式关。" or "Test mode off"}
        },
        default = false,
    ...
    addTitle(Ch and "==自动清理细项==" or "Automatic Cleaning Of Details"),
    {
        ...
        default = 6,	
        hover = Ch and "触手尖刺的最大数量" or "the maximum amount of the tentaclespike"
    },
    {
        name = "grassgekko",
        ...
        default = 10,	
        hover = Ch and "草蜥蜴的最大数量" or "the maximum amount of the grassgekko"
    },
    {
        name = "armor_sanity",
        ...
        default = 2,	
        hover = Ch and "影甲的最大数量" or "the maximum amount of the armor_sanity"
    },
    {
        name = "shadowheart",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "影心的最大数量" or "the maximum amount of the shadowheart"
    },
    {
        name = "hound",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "狗的最大数量" or "the maximum amount of the hound"
    },
    {
        name = "firehound",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "火狗的最大数量" or "the maximum amount of the firehound"
    },
    {
        name = "spider",
    ...
    },
    {
        ...
        options = cleanunitx10_2,
        default = 4,	
        hover = Ch and "苍蝇/蚊子的最大数量" or "the maximum amount of the flies/mosquito"
    },
    {
        name = "bee",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "蜜蜂/杀人蜂的最大数量" or "the maximum amount of the bee/killerbee"
    },
    {
        name = "frog",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "青蛙的最大数量" or "the maximum amount of the frog"
    },
    {
        name = "beefalo",
        ...
        default = 30,	
        hover = Ch and "牛的最大数量" or "the maximum amount of the beefalo"
    },
    {
        name = "deer",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "鹿的最大数量" or "the maximum amount of the deer"
    },
    {
        name = "slurtle",
        ...
        options = cleanunitx30_5,
        default = 5,	
        hover = Ch and "鼻涕虫/蜗牛的最大数量" or "the maximum amount of the slurtle/snurtle"
    },
    {
        name = "rocky",
        ...
        options = cleanunitx60_10,
        default = 20,	
        hover = Ch and "石虾的最大数量" or "the maximum amount of the rocky"
    },
    {
        ...
        default = 140,	
        hover = Ch and "常青树的最大数量" or "the maximum amount of the evergreen_sparse"
    },
    {
        name = "twiggytree",
        ...
        options = cleanunitx200_20,
        default = 140,	
        hover = Ch and "树枝树的最大数量" or "the maximum amount of the twiggytree"
    },
    {
        name = "marsh_tree",
        ...
        options = cleanunitx200_20,
        default = 100,	
        hover = Ch and "针刺树的最大数量" or "the maximum amount of the marsh_tree"
    },
    {
        ...
        options = cleanunitx200_20,
        default = 140,	
        hover = Ch and "石化树的最大数量" or "the maximum amount of the rock_petrified_tree"
    },
    {
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "玩家尸体的最大数量" or "the maximum amount of the skeleton_player"
    },
    {
        name = "spiderden",
        ...
        options = cleanunitx30_5,
        default = 20,	
        hover = Ch and "蜘蛛巢的最大数量" or "the maximum amount of the spiderden"
    },
    {
        name = "burntground",
        ...
        options = cleanunitx10_2,
        default = 4,	
        hover = Ch and "陨石痕跡的最大数量" or "the maximum amount of the burntground"
    },
    {
        name = "seeds",
        ...
        options = cleanunitx30_5,
        default = 10,	
        hover = Ch and "种子的最大数量" or "the maximum amount of the seeds"
    },
    {
        name = "log",
        ...
        options = cleanunitx200_20,
        default = 60,	
        hover = Ch and "木头的最大数量" or "the maximum amount of the log"
    },
    {
        name = "pinecone",
        ...
        options = cleanunitx200_20,
        default = 60,	
        hover = Ch and "松果的最大数量" or "the maximum amount of the pinecone"
    },
    {
        name = "cutgrass",
        ...
        options = cleanunitx60_10,
        default = 10,	
        hover = Ch and "草的最大数量" or "the maximum amount of the cutgrass"
    },
    {
        name = "twigs",
        ...
        options = cleanunitx60_10,
        default = 10,	
        hover = Ch and "树枝的最大数量" or "the maximum amount of the twigs"
    },
    {
        name = "rocks",
        ...
        options = cleanunitx60_10,
        default = 40,	
        hover = Ch and "石头的最大数量" or "the maximum amount of the rocks"
    },
    {
        name = "nitre",
        ...
        options = cleanunitx60_10,
        default = 40,	
        hover = Ch and "硝石的最大数量" or "the maximum amount of the nitre"
    },
    {
        name = "flint",
        ...
        options = cleanunitx60_10,
        default = 40,	
        hover = Ch and "燧石的最大数量" or "the maximum amount of the flint"
    },
    {
        name = "poop",
        ...
        options = cleanunitx30_5,
        default = 2,	
        hover = Ch and "粪便的最大数量" or "the maximum amount of the poop"
    },
    {
        name = "guano",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "鸟粪的最大数量" or "the maximum amount of the guano"
    },
    {
        name = "manrabbit_tail",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "兔毛尾巴的最大数量" or "the maximum amount of the manrabbit_tail"
    },
    {
        name = "silk",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "蜘蛛丝的最大数量" or "the maximum amount of the silk"
    },
    {
        name = "spidergland",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "蜘蛛腺体的最大数量" or "the maximum amount of the spidergland"
    },
    {
        name = "stinger",
        ...
        options = cleanunitx10_2,
        default = 2,
        hover = Ch and "蜂刺的最大数量" or "the maximum amount of the stinger"
    },
    {
        name = "houndstooth",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "狗牙的最大数量" or "the maximum amount of the houndstooth"
    },
    {
        name = "mosquitosack",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "蚊子血袋的最大数量" or "the maximum amount of the mosquitosack"
    },
    {
        name = "glommerfuel",
        ...
        options = cleanunitx10_2,
        default = 10,	
        hover = Ch and "格罗姆粘液的最大数量" or "the maximum amount of the glommerfuel"
    },
    {
        name = "slurtleslime",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "鼻涕虫粘液/鼻涕虫壳碎片的最大数量" or "the maximum amount of the slurtleslime/slurtle_shellpieces"
    },
    {
        name = "spoiled_food",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "腐烂食物的最大数量" or "the maximum amount of the spoiled_food"
    },
    {
        name = "festival",
        label = Ch and "节日小饰品/食物/玩具" or "winter_ornament_plain/winter_ornament_boss/halloweencandy/trinket/winter_food",
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "节日小饰品/食物/玩具的最大数量" or "the maximum amount of the winter_ornament_plain/winter_ornament_boss/halloweencandy/trinket/winter_food"
    },
    {
        name = "blueprint",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "蓝图的最大数量" or "the maximum amount of the blueprint"
    },
    {
        name = "axe",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "斧子的最大数量" or "the maximum amount of the axe"
    },
    {
        name = "torch",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "火把的最大数量" or "the maximum amount of the torch"
    },
    {
        name = "pickaxe",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "镐子的最大数量" or "the maximum amount of the pickaxe"
    },
    {
        name = "hammer",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "锤子的最大数量" or "the maximum amount of the hammer"
    },
    {
        name = "shovel",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "铲子的最大数量" or "the maximum amount of the shovel"
    },
    {
        name = "razor",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "剃刀的最大数量" or "the maximum amount of the razor"
    },
    {
        name = "pitchfork",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "干草叉的最大数量" or "the maximum amount of the pitchfork"
    },
    {
        name = "bugnet",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "捕虫网的最大数量" or "the maximum amount of the bugnet"
    },
    {
        name = "fishingrod",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "鱼竿的最大数量" or "the maximum amount of the fishingrod"
    },
    {
        name = "spear",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "长矛的最大数量" or "the maximum amount of the spear"
    },
    {
        name = "earmuffshat",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "兔耳罩的最大数量" or "the maximum amount of the earmuffshat"
    },
    {
        name = "winterhat",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "冬帽的最大数量" or "the maximum amount of the winterhat"
    },
    {
        name = "heatrock",
        ...
        options = cleanunitx10_2,
        default = 10,	
        hover = Ch and "暖石的最大数量" or "the maximum amount of the heatrock"
    },
    {
        name = "trap",
        ...
        options = cleanunitx60_10,
        default = 30,	
        hover = Ch and "动物陷阱的最大数量" or "the maximum amount of the trap"
    },
    {
        name = "birdtrap",
        ...
        options = cleanunitx60_10,
        default = 10,	
        hover = Ch and "鸟陷阱的最大数量" or "the maximum amount of the birdtrap"
    },
    {
        name = "compass",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "指南针的最大数量" or "the maximum amount of the compass"
    },
    {
        name = "driftwood_log",
        ...
        options = cleanunitx200_20,
        default = 100,	
        hover = Ch and "浮木的最大数量" or "the maximum amount of the driftwood_log"
    },
    {
        name = "spoiled_fish",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "变质鱼/小鱼的最大数量" or "the maximum amount of the spoiled_fish/small"
    },
    {
        name = "rottenegg",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "臭鸡蛋的最大数量" or "the maximum amount of the rottenegg"
    },
    {
        name = "feather",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "羽毛/啜食兽皮的最大数量" or "the maximum amount of the feather/slurper_pelt"
    },
    {
        name = "pocket_scale",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "弹簧秤的最大数量" or "the maximum amount of the pocket_scale"
    },
    {
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "海钓竿的最大数量" or "the maximum amount of the oceanfishingrod"
    },
    {
        name = "sketch",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "所有草图的最大数量" or "the maximum amount of all the sketch"
    },
    {
        name = "tacklesketch",
        ...
        options = cleanunitx10_2,
        default = 2,	
        hover = Ch and "所有钓具草图的最大数量" or "the maximum amount of all the tacklesketch"
    }
}