...
function BeefaloStatusBar:UpdateDomestication(domestication, tendency)
    ...
    if self.tendency ~= tendency then
        ...
        self.domesticationBadge.anim:GetAnimState():SetMultColour(unpack(self.CONFIG.BADGE_COLORS[tendency] or self.CONFIG.BADGE_COLORS.ORNERY))
    end
end
...
} local function OnLoadYLZS() local YLZS = GetModConfigData("YLZS","workshop-2995399263") L = L[YLZS] or {} end
