...
TUNING.MOD_LOL_WP = {
    ...
    DEMONICEMBRACEHAT = { -- 恶魔之拥 头盔
        ...
        SKILL_STARE = { -- 被动：【亚扎卡纳的凝视】
            CD = 10, -- 冷却
            MAXHP_PERCENT = .004, -- 对一名敌人造成伤害时，会造成相当于其1%最大生命值的额外位面伤害
            DURATION = 4,
            INTERVAL = 1,
        },
        SHADOW_LEVEL = 4,
        ...
        DURABILITY = 2000, --  耐久
        extra_planar_dmg = 20, -- 恶魔之拥加强：获得20额外位面伤害
    },
    --------------------------------------
    ---------------S7------------------
    --------------------------------------
    ...
    HUBRIS = {
        ...
        SKILL_REPUTATION = { -- 被动：【盛名
            BOSSKILL_BY_SELF_STACK = 2, -- 当你击杀一个boss时，会增加1层盛名
    ...
    LIANDRY = {
        ABSORB = .4, -- 防御
        DEFEND_PLANAR = 20, -- 位面防御
        extra_planar_dmg = 20, -- 大面具加强：获得20额外位面伤害
        SKILL_TORMENT = { -- 被动【折磨】
            INTERVAL = 1, -- 燃烧间隔
            DURATION = 3, -- 燃烧持续时间
            CD = 5, -- 技能冷却时间
            MAXHP_PERCENT_PLANAR_DMG = .008, -- 造成1%最大生命值的位面伤害，
        },
        SKILL_SUFFER = { -- 被动【受苦】
            PLANAR_DMG = .2, -- 你的攻击附带当前造成伤害20%的额外位面伤害
    ...
    ARCHANGELSTAFF = {
        ...
        UPGRADE = { -- 升级
            ...
            SKILL_SHIELD = { -- 被动：【救主灵刃】
                ...
                SHIELD_DURATION = 8, -- 提供持续3秒的无敌护盾
                CD = 40, -- 冷却时间40秒。
                regen_maxhp_percent = .2 -- 炽天使之拥加强，触发救主灵刃时，额外回复自身最大生命值20%的血量。
            },
    ...
    lol_wp_s20_iceborngauntlet_shield = {
        DMG = 51,
        ABSORB = .85,
        atk_attach_coldness = .5, -- 攻击附带0.5层冰冻
        WALKSPEEDMULT = .9, -- 移速
        SKILL_CURSEBLADE = { -- 被动：【咒刃】
            dmgmult_when_attached = 2, -- 造成200%的伤害
            area_radius = 3, -- 并生成一个半径3码的冰冷地带

            area_radius_add_from_absorb = .1, -- (每10%护甲)增加0.1半径。
            area_radius_per_absorb = .1, -- 每10%护甲(增加0.1半径。)

            area_walkspeedmult = .75, -- 这个地带可造成25%减速
            area_duration = 2, -- 持续2

            area_addcoldness_interval = 2.1, -- 每1秒附加冰冻
            area_addcoldness_per_interval = .5, -- 每次0.5层冰冻
            area_deal_physical_dmg_per_interval = 20, -- 每次造成20点物理伤害
            area_cd = 2, -- 冷却时间2秒
        },
        skill_breakice = {
            extra_physical_dmg = 80,
        },
        BLUEPRINTDROP_CHANCE = {
            sharkboi = 1,
        },
    ...
    lol_wp_s20_wardenmail_armor = {
        ...
        WATERPROOF = .2, -- 防水
        WALKSPEEDMULT = .9, -- 移速
        skill_stone = { -- 被动：【坚如磐石】获得10%伤害减免+自身最大生命值1%的额外伤害减免，最多获得10%的额外伤害减免，共20%。
            defence = .1,
            defence_maxhp_percent = .02,
            max_defence_maxhp = .2
        },
        FINITEUSES = 1200,
    },
    ...
    lol_wp_s20_frozenheart_armor = {
        ...
        DARPPERNESS = 4,
        skill_wintertouch = {
            addcoldness_when_getattacked = 1, -- 受到攻击时对目标施加1层冰冻
            temperature = 30,
        },
        BLUEPRINTDROP_CHANCE = {
            crabking = 1,
    ...
    -------- 套装
    sets = {
        --   1 渴血战斧+虚空风帽+虚空长袍触发套装效果：
        -- 【强攻】第3次攻击额外造成40位面伤害，对目标施加10%易伤，持续6秒，冷却10秒
        s1 = {
            every_hit = 3,
            planar_dmg = 80,
            dmgtakenmult = 1.1, -- 修改成: 增伤玩家了
            duration = 6,
            cd = 10,
        },

        --2 挺进破坏者+亮茄头盔+亮茄盔甲触发套装效果：
        -- 【相位猛冲】累计攻击3次后获得30%移速，持续3秒，冷却10秒
        s2 = {
            every_hit = 3,
            WALKSPEEDMULT = 1.3,
            duration = 3,
        ...
        s4 = {},
        -- 狂妄+荆棘之甲触发套装效果：
        -- 【恶意中伤】荆棘之甲反伤附带等同于狂妄层数的额外真实伤害。
        s5 = {},
        -- 焚天+铥矿套触发套装效果：
        -- 【凯旋】击杀目标回复自身6点生命值和6点理智值。
        s6 = {
            kill_regen_hp = 6,
            kill_regen_san = 6,
        },
        ...
        -- 【过载充能】攻击带电。
        s7 = {},
        -- 巨型九头蛇+霸王血铠+恶魔之拥触发套装效果：
        -- 【坚毅不倒】生命值低于60%时获得10%攻击倍率提升，低于30%时获得20%攻击倍率提升。
        s8 = {
            hp_below = .6,
            dmgmult = 1.1,
        ...
        -- 日炎圣盾+荆棘之甲+兰德里的折磨触发套装效果：
        -- 【打我等于打自己】荆棘之甲反伤时会额外触发一次日炎格挡成功的范围伤害，日炎圣盾格挡成功时额外触发一次反甲的反伤。
        -- 日炎和反甲造成的伤害均可以触发大面具的灼烧被动。
        s9 = {
