...
params.lol_wp_s20_iceborngauntlet_shield = {
    widget = {
        animbank = 'ui_alterguardianhat_1x1',
        animbuild = 'ui_alterguardianhat_1x1',
        pos = Vector3(300,-325,0),
        slotpos = {Vector3(0,17,0)},
        slotbg = {},
        dragtype_drag = 'lol_wp_s20_iceborngauntlet_shield',
    },
    type = 'lol_wp_s20_iceborngauntlet_shield',
    -- ---comment
    -- ---@param container any
    -- ---@param item ent
    -- ---@param slot any
