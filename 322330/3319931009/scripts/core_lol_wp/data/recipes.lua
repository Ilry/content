...
local data = {
	...
	-- 冰脉护手】（护甲栏）
	{
		recipe_name = 'lol_wp_s20_iceborngauntlet_shield',
		ingredients = {
			Ingredient("lol_wp_sheen",1,'images/inventoryimages/lol_wp_sheen.xml'),
			Ingredient("armormarble",1),
			Ingredient("bluegem",5),
	...
	-- 守望者铠甲】（护甲栏）
	{
		recipe_name = 'lol_wp_s20_wardenmail_armor',
		ingredients = {
			Ingredient("armormarble",1),
			Ingredient("bluegem",1),
			Ingredient("moonrocknugget",4),
	...
	-- 冰霜之心】（护甲栏）
	{
		recipe_name = 'lol_wp_s20_frozenheart_armor',
		ingredients = {
			Ingredient("lol_wp_s20_wardenmail_armor",1,'images/inventoryimages/lol_wp_s20_wardenmail_armor.xml'),
			Ingredient("blueamulet",1),
			Ingredient("opalpreciousgem",1),
			Ingredient("ice",200),
			Ingredient("moonglass",24),
		},
		tech = TECH.LOST, 
		config = {
		},
