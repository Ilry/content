...
local data = {
	...
	-- 灭世者的死亡之帽
	{
		...
		filters = {'CLOTHING','TAB_LOL_WP','MODS'},
	},
	-- 无用大棒
	{
	...
	-- 巫妖之祸
	{
		...
		filters = {'CRAFTING_STATION','TAB_LOL_WP','MODS','WEAPONS'},
	},
	-- s9
	-- -- 引路者（储物栏
	-- {
	...
	-- 	tech = TECH.SCIENCE_TWO,
	-- 	config = {},
	-- 	filters = {'CONTAINERS','TAB_LOL_WP','MODS'}
	-- },
	-- -- 戒备眼石
	-- {
	...
	-- 		nounlock = true,
	-- 	},
	-- 	filters = {'CRAFTING_STATION','TAB_LOL_WP','MODS'},
	-- }
}
