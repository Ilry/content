...
local data = {
    ...
    pedia_items = { -- 所有图鉴物品
        ...
        lol_wp_s20_iceborngauntlet_shield = {
            name = lang.lol_wp_pedia_group_label.lol_wp_s20_iceborngauntlet_shield,
            name_rgba = {38/255,221/255,223/255,1},
            group = 'tank',
            info = {},
        },
        ...
        lol_wp_s20_wardenmail_armor = {
            name = lang.lol_wp_pedia_group_label.lol_wp_s20_wardenmail_armor,
            group = 'tank',
            info = {},
        },
        -- 冰霜之心
        lol_wp_s20_frozenheart_armor = {
            name = lang.lol_wp_pedia_group_label.lol_wp_s20_frozenheart_armor,
            name_rgba = {38/255,221/255,223/255,1},
            group = 'tank',
            info = {},
        },
