...
local data = {
    ...
    lol_wp_pedia_group_label = { -- 所有物品的左边栏label
        ...
        lol_wp_s20_iceborngauntlet_shield = '冰脉护手',
        lol_wp_s20_wardenmail_armor = '守望者铠甲',
        lol_wp_s20_frozenheart_armor = '冰霜之心',
    },
    pedia_items = { -- 图鉴物品
        lol_wp_s7_cull = {
            name = '萃取',
        ...
        lol_wp_s20_iceborngauntlet_shield = {
            name = '冰脉护手',
            info_instead = '- 类型：近战武器/拳套\n- 攻击力：'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.DMG..'\n- 防御力：'..(TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.ABSORB*100)..'%\n- 攻击附带'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.atk_attach_coldness..'层冰冻\n- 移速'..((TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.WALKSPEEDMULT-1)>0 and '+' or '-')..(math.abs(TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.WALKSPEEDMULT-1)*100)..'%\n- 有1个特殊的格子，装备时会自动打开，格子内有冰箱效果，可以保鲜和制冷。\n- 被动：【咒刃】\n\t攻击会触发一次强化攻击，造成'..(TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.dmgmult_when_attached*100)..'%的伤害，并生成一个半径'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_radius..'码的冰冷地带，这个地带可造成'..((1-TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_walkspeedmult)*100)..'%减速，持续'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_duration..'秒，并对范围内的目标施加'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_addcoldness_per_interval..'层冰冻并造成'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_deal_physical_dmg_per_interval..'物理伤害，冷却时间'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_cd..'秒。每装备一件拥有护甲的装备可以增加冰冷地带的范围，每'..(TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_radius_per_absorb*100)..'%护甲增加'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.SKILL_CURSEBLADE.area_radius_per_absorb..'半径。\n- 被动：【破冰拳】\n\t攻击被冰冻的生物造成额外'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.skill_breakice.extra_physical_dmg..'物理伤害，并击退该目标。\n- 属于月亮阵营，对暗影阵营伤害增加'..((TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.DMGMULT_TO_SHADOW-1)*100)..'%。\n- 击败大霜鲨'..(TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.BLUEPRINTDROP_CHANCE.sharkboi*100)..'%掉落蓝图。\n- 耐久：'..TUNING.MOD_LOL_WP.lol_wp_s20_iceborngauntlet_shield.FINITEUSES..'，耐久耗尽不会损坏',
        },
        lol_wp_s20_wardenmail_armor = {
            name = '守望者铠甲',
            info_instead = '- 类型：护甲装备/盔甲\n- 防御：'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.ABSORB*100)..'%\n- 防水：'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.WATERPROOF*100)..'%\n- 穿戴时免疫击飞。\n- 移速'..((TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.WALKSPEEDMULT-1)>0 and '+' or '-')..(math.abs(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.WALKSPEEDMULT-1)*100)..'%。\n- 被动：【坚如磐石】\n\t获得'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence*100)..'%伤害减免+自身最大生命值'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence_maxhp_percent*100)..'%的额外伤害减免，最多获得'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.max_defence_maxhp*100)..'%的额外伤害减免，共'..((TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence + TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.max_defence_maxhp)*100)..'%。\n- 【坚如磐石】在装备两件同类型装备时只会触发最大值，不可叠加。\n- 耐久：'..TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.FINITEUSES..'，耐久耗尽会损坏',
        },
        lol_wp_s20_frozenheart_armor = {
            name = '冰霜之心',
            info_instead = '- 类型：护符/护甲/魔法石\n- 防御：'..(TUNING.MOD_LOL_WP.lol_wp_s20_frozenheart_armor.ABSORB*100)..'%\n- 理智：+'..TUNING.MOD_LOL_WP.lol_wp_s20_frozenheart_armor.DARPPERNESS..'san/min\n- 被动：【凛冬之抚】\n\t佩戴时有寒冰护符的效果，受到攻击时对目标施加'..TUNING.MOD_LOL_WP.lol_wp_s20_frozenheart_armor.skill_wintertouch.addcoldness_when_getattacked..'层冰冻，佩戴时玩家恒温'..TUNING.MOD_LOL_WP.lol_wp_s20_frozenheart_armor.skill_wintertouch.temperature..'℃，免疫过冷过热，免疫冰面滑倒的影响。\n- 被动：【坚如磐石】\n\t获得'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence*100)..'%伤害减免+自身最大生命值'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence_maxhp_percent*100)..'%的额外伤害减免，最多获得'..(TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.max_defence_maxhp*100)..'%的额外伤害减免，共'..((TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.defence + TUNING.MOD_LOL_WP.lol_wp_s20_wardenmail_armor.skill_stone.max_defence_maxhp)*100)..'%。\n- 【坚如磐石】在装备两件同类型装备时只会触发最大值，不可叠加。\n- 属于月亮阵营。\n- 击败帝王蟹'..(TUNING.MOD_LOL_WP.lol_wp_s20_frozenheart_armor.BLUEPRINTDROP_CHANCE.crabking*100)..'%掉落蓝图。\n- 耐久：无',
        },
    },
