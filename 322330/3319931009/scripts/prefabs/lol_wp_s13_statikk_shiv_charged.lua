local prefab_id = "lol_wp_s13_statikk_shiv_charged"
local assets_id = "lol_wp_s13_statikk_shiv_charged"

local db = TUNING.MOD_LOL_WP.STATIKK_SHIV_CHARGED
...
local function onfinished(inst)
    ...
    if owner and owner:HasTag('player') then
        owner.components.inventory:GiveItem(SpawnPrefab('lol_wp_s13_statikk_shiv'))
    end
    inst:Remove()
end
