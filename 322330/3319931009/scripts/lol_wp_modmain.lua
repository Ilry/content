...
local new_Assets = {
	...
	Asset("ANIM","anim/mastupgrade_lightningrod_fx.zip"),
}
...
TUNING[string.upper('CONFIG_'..modid..'lol_wp_s20_frozenheart_armor_fx')] = GetModConfigData('lol_wp_s20_frozenheart_armor_fx')
...
TUNING[string.upper('CONFIG_'..modid..'fx_radius_adjust')] = GetModConfigData('fx_radius_adjust')
...
TUNING[string.upper('CONFIG_'..modid..'special_settings_nocd')] = GetModConfigData('special_settings_nocd') or 1 -- number 无限活力用的cd倍率
TUNING[string.upper('CONFIG_'..modid..'special_settings_nocd_allitems')] = GetModConfigData('special_settings_nocd_allitems') -- 比无限火力模式多了“包含原版和其他mod中拥有冷却的装备。”
...
modimport('scripts/core_'..modid..'/hooks/whenconstruct.lua') -- 当分解组件工作时
modimport('scripts/core_'..modid..'/hooks/lol_wp_s20_iceborngauntlet_shield.lua') -- 冰脉护手
modimport('scripts/core_'..modid..'/hooks/temperature.lua') -- 温度
modimport('scripts/core_'..modid..'/hooks/lol_wp_s20_frozenheart_armor.lua') -- 冰霜之心
modimport('scripts/core_'..modid..'/hooks/pin.lua')
modimport('scripts/core_'..modid..'/hooks/minimap.lua') -- 小地图
...
modimport('scripts/core_'..modid..'/skins/lol_wp_s10_sunfireaegis.lua')
modimport('scripts/core_'..modid..'/skins/lol_wp_s10_sunfireaegis_armor.lua')
modimport('scripts/core_'..modid..'/skins/lol_wp_warmogarmor.lua')
modimport('scripts/core_'..modid..'/skins/lol_wp_s8_deathcap.lua')
modimport('scripts/core_'..modid..'/skins/lol_wp_s19_fimbulwinter_armor_upgrade.lua')
modimport('scripts/core_'..modid..'/skins/lol_wp_s19_fimbulwinter_armor.lua')
