...
--------------------change part--------------
    if inst._forced_nightvision:value() == true then
        ...
        -- GetWorld().components.colourcubemanager:SetOverrideColourCube("images/colour_cubes/dusk03_cc.tex")
    --------------------change part--------------
    end
end
