...
TUNING.WX78_MAXELECTRICCHARGE=20
...
-- 		self.onremovedfromownerfn=_dummy
-- 	end)
-- end)
local OnUpgradeModulesListDirty = function(inst)
    if inst._parent ~= nil then
        ...
        if module1 == 0 and module2 == 0 and module3 == 0 and module4 == 0 and module5 == 0 and module6 == 0 and module7 == 0 and module8 == 0 and module9 == 0 and module10 == 0 and module11 == 0 and module12 == 0  and module13 == 0  and module14 == 0  and module15 == 0  and module16 == 0  and module17 == 0  and module18 == 0  and module19 == 0  and module20 == 0 then
            inst._parent:PushEvent("upgrademoduleowner_popallmodules")
        else
            inst._parent:PushEvent("upgrademodulesdirty", {module1, module2, module3, module4, module5, module6, module7, module8, module9, module10, module11, module12, module13, module14, module15, module16, module17, module18, module19, module20})
        end
    end
end
...
T.WX78_MAXSANITY_DAPPERNESS = 100/(30*10)--理智效果
		
T.WX78_MAXHUNGER1_BOOST = 100--一级饱食电路
T.WX78_MAXHUNGER_BOOST = 200--二级饱食电路
T.WX78_MAXHUNGER_SLOWPERCENT = 0.85--饱食减缓效果
