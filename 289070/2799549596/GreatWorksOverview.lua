				...
				if(pCityBldgs:HasBuilding(buildingIndex)) then
					...
					if (numSlots ~= nil and numSlots > 0) then
						...
						for index=0,numSlots-1 do
							local str=GameInfo.GreatWorkSlotTypes[pCityBldgs:GetGreatWorkSlotType(buildingIndex, index)].GreatWorkSlotType;
                            
                            if choose=="ALL" then 
                            	key=true;
                            elseif choose=="OTHER" then 
                            	if str=="GREATWORKSLOT_ART" then
                            	    key=true;
                            	elseif str=="GREATWORKSLOT_ARTIFACT" then
                                    key=true;
                                elseif str=="GREATWORKSLOT_PALACE" then 
                            	    key=true; 
                            	end
                            elseif choose=="RELIC" then 
                            	if str=="GREATWORKSLOT_RELIC" then
                            	    key=true;
                            	elseif str=="GREATWORKSLOT_CATHEDRAL" then
                                    key=true;
                                elseif str=="GREATWORKSLOT_PALACE" then 
                            	    key=true; 
                            	end	
                            elseif str==choose then 
                            	key=true; 
                            elseif str=="GREATWORKSLOT_PALACE" then 
                            	key=true; 
                            end
...
---------------------------------------------------------------------------------
function OnArt()
    if choose=="GREATWORKSLOT_ART" then
       choose="ALL";
       Controls.Art:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="GREATWORKSLOT_ART";
       Controls.Art:SetSelected(true);
       Controls.Theme:SetSelected(false);
       Controls.Relic:SetSelected(false);
       Controls.Production:SetSelected(false);
       Controls.Music:SetSelected(false);
       Controls.Artifact:SetSelected(false);
       Controls.Writing:SetSelected(false);
       UpdateGreatWorks();
	end
end

function OnProduction()
	if choose=="GREATWORKSLOT_PRODUCT" then
       choose="ALL";
       Controls.Production:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="GREATWORKSLOT_PRODUCT";
       Controls.Production:SetSelected(true);
       Controls.Art:SetSelected(false);
       Controls.Relic:SetSelected(false);
       Controls.Theme:SetSelected(false);
       Controls.Music:SetSelected(false);
...
function OnArtifact()
	if choose=="GREATWORKSLOT_ARTIFACT" then
       choose="ALL";
       Controls.Artifact:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="GREATWORKSLOT_ARTIFACT";
       Controls.Artifact:SetSelected(true);
       Controls.Art:SetSelected(false);
       Controls.Relic:SetSelected(false);
       Controls.Writing:SetSelected(false);
       Controls.Theme:SetSelected(false);
...
function OnMusic()
	if choose=="GREATWORKSLOT_MUSIC" then
       choose="ALL";
       Controls.Music:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="GREATWORKSLOT_MUSIC";
       Controls.Art:SetSelected(false);
       Controls.Relic:SetSelected(false);
       Controls.Writing:SetSelected(false);
       Controls.Artifact:SetSelected(false);
       Controls.Production:SetSelected(false);
       Controls.Music:SetSelected(true);
       Controls.Theme:SetSelected(false);
       UpdateGreatWorks();
	end
end
...
function OnWriting()
	if choose=="GREATWORKSLOT_WRITING" then
       choose="ALL";
       Controls.Writing:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="GREATWORKSLOT_WRITING";
       Controls.Art:SetSelected(false);
       Controls.Relic:SetSelected(false);
       Controls.Production:SetSelected(false);
       Controls.Music:SetSelected(false);
       Controls.Artifact:SetSelected(false);
       Controls.Writing:SetSelected(true);
       Controls.Theme:SetSelected(false);
       UpdateGreatWorks();
	end
end
...
function OnRelic()
	if choose=="RELIC" then
       choose="ALL";
       Controls.Relic:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="RELIC";
       Controls.Relic:SetSelected(true);
       Controls.Art:SetSelected(false);
       Controls.Production:SetSelected(false);
       Controls.Music:SetSelected(false);
       Controls.Artifact:SetSelected(false);
...
function OnTheme()
	if choose=="OTHER" then
       choose="ALL";
       Controls.Theme:SetSelected(false);
       UpdateGreatWorks();
	else
       choose="OTHER";
       Controls.Theme:SetSelected(true);
       Controls.Relic:SetSelected(false);
       Controls.Art:SetSelected(false);
       Controls.Production:SetSelected(false);
       Controls.Music:SetSelected(false);
...
function Initialize()
	...
	Controls.Art:RegisterCallback(Mouse.eLClick,	OnArt);
	Controls.Production:RegisterCallback(Mouse.eLClick, OnProduction);
	Controls.Music:RegisterCallback(Mouse.eLClick,	OnMusic);
	Controls.Relic:RegisterCallback(Mouse.eLClick,	OnRelic);
	Controls.Writing:RegisterCallback(Mouse.eLClick,	OnWriting);
	Controls.Artifact:RegisterCallback(Mouse.eLClick,	OnArtifact);
    Controls.Theme:RegisterCallback(Mouse.eLClick,	OnTheme);
	Controls.Theme:RegisterCallback( Mouse.eMouseEnter,     function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Art:RegisterCallback( Mouse.eMouseEnter,     function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Production:RegisterCallback(Mouse.eMouseEnter, function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Music:RegisterCallback(Mouse.eMouseEnter,    function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Relic:RegisterCallback(Mouse.eMouseEnter,    function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Writing:RegisterCallback(Mouse.eMouseEnter,  function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	Controls.Artifact:RegisterCallback(Mouse.eMouseEnter,      function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
