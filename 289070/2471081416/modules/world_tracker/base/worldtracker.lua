...
-- CUI -----------------------------------------------------------------------
function CuiInit()
    ContextPtr:BuildInstanceForControl("CuiTrackerInstance", cui_TrackBar, Controls.WorldTrackerVerticalContainer)
	Controls.OtherContainer:ChangeParent( Controls.WorldTrackerVerticalContainer );

    CuiTrackPanelSetup()

    ContextPtr:BuildInstanceForControl("GossipLogInstance", cui_GossipPanel, Controls.WorldTrackerVerticalContainer)
    ContextPtr:BuildInstanceForControl("CombatLogInstance", cui_CombatPanel, Controls.WorldTrackerVerticalContainer)
	Controls.OtherContainer:ChangeParent( Controls.WorldTrackerVerticalContainer );
