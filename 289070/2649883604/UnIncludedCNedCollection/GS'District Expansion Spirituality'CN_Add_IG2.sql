...
-- GS'District Expansion Spirituality'CN_Add_IG2
-- Author: 牛奶大魔王 , Clear8Sky
-- DateCreated: 2021/9/16 2:37:38
--------------------------------------------------------------

-- 该文件对应补译/润色模组 “District Expansion: Spirituality”的 UC_REL_Text_CS_Ethiopia.sql 文件。该文件在 InGame 时载入，需 Criteria ： Active_Expansion_2 与 Active_DLC_Ethiopia 与 Disable_Mod_CSE

---- 对 有 埃塞俄比亚DLC 、无 城邦扩充 模组 时宗教城邦的加成文本进行改动，已添加 Criteria 以保证其载入的特定条件，但还需添加条件语句，只有原模组启用时以下替换才生效
