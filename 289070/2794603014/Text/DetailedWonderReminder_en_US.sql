...
VALUES	('en_US',	'LOC_KNM_REMINDER_BUILDING',				'{1_CivName} [ICON_Turn] {2_Number}'),
		...
		('en_US',	'LOC_KNM_REMINDER_TITLE',					'Wonder Reminder Enhanced'),
		('en_US',	'LOC_KNM_REMINDER_LAUNCH_NAME',				'Wonder Reminder Enhanced[NEWLINE][NEWLINE]Displays build information for all civilizations and your producible cities for each wonder. The default shortcut key is K, which can be modified in the options.'),
