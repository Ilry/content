-- ATRI_GF_sots_ui
-- Author: UFO300
-- DateCreated: 4/1/2021 10:03:41 PM
--------------------------------------------------------------
...
function OnSettleButtonClicked()
    ...
    if IsValidCityDistance(iX, iY) then
        ...
        local msg = Locale.Lookup('LOC_CITY_TOO_CLOSE_GF', m_CityMinRange)
...
function Setup()
    ...
    if (GameConfiguration.GetValue("GAMEMODE_BCOS") == true) and ctrl ~= nil then
