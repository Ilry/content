...
local ResourceWgtIdx = 0.8;	

local additionFeatureChance = 0.5;
local rsDiscov_BaseRate = 30;
local rsDiscov_PoolWeights = rsDiscov_BaseRate;
local rsDiscov_PoolWealth = 18;
local rsDiscov_PoolCharges = 4;
local rsDiscov_PoolChargeRate = 4;
...
local function Initialize()
	print( " ################ Start Initializing yugongyishan Gameplay Script (Rate High)... ################ " );
	...
	print( " ################ End Initializing yugongyishan Gameplay Script	(Rate High)... ################ " );
end
Initialize();